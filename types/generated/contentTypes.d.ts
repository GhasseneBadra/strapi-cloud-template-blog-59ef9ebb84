...
export interface ApiAssistantAssistant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    AtImg: Schema.Attribute.Media<'images' | 'files'> &
...
export interface ApiAttorneyAttorney extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contactInfo: Schema.Attribute.Component<'team.contact-info', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    professionalExp: Schema.Attribute.Component<
    ...
    skillAchievement: Schema.Attribute.Component<
      'team.skill-achievements',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    socialMedia: Schema.Attribute.Component<'team.social-media', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHeroSliderHeroSlider extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Manage hero section slider content';
...
export interface ApiManagerManager extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    skillsAchievements: Schema.Attribute.Component<
      'team.skill-achievements',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    socialMedia: Schema.Attribute.Component<'team.social-media', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPracticeAreaPracticeArea
  ...
  attributes: {
    additionalDetails: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    services: Schema.Attribute.Component<'practice-area.service', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
